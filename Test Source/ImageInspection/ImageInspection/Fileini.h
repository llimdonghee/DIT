// Ini.h: Schnittstelle  die Klasse CIni.
...
//#define SER_2DARR(bGet,value,n,m) SerGet(bGet,value,n,m,#value,NULL,0)

//#define SER_2DARR(bGet,value,n,m) SerGet(bGet,value,n,m,#value,NULL,0)
//#define SER_2DARRD(bGet,value,n,m,default) SerGet(bGet,value,n,m,#value,default)
...
public:
	...
	void		SerGet(	BOOL bGet,unsigned int		& n,	CString strEntry,	LPCSTR strSection = NULL,	int nDefault = 0);
	void		SerGet(	BOOL bGet,short		& n,	CString strEntry,	LPCSTR strSection = NULL,	int nDefault = 0);
	void		SerGet(	BOOL bGet,unsigned short		& n,	CString strEntry,	LPCSTR strSection = NULL,	int nDefault = 0);
...
//2D ARRAYs
	void		SerGet(	BOOL bGet,int *n, int nCount1, int nCount2, CString strEntry, LPCSTR strSection = NULL,	int nDefault = 0);
